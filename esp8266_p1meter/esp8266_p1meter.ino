...
void setup()
{
    ...
    const char* custom_css = "<meta name='viewport' content='width=device-width,initial-scale=1.0'>"
                             ...
                             "button,a,input[type='button'],input[type='submit']{display:block;width:100%;background:#0f0;color:#000;border:none;padding:15px;cursor:pointer;font-weight:bold;margin-top:15px;text-align:center;text-decoration:none;font-size:18px;box-sizing:border-box;border-radius:2px;-webkit-appearance:none;}"
                             "button:hover,a:hover,input[type='button']:hover,input[type='submit']:hover{background:#0a0;}"
