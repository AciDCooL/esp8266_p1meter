...
float L1_INSTANT_POWER_CURRENT = 0.0;
float L2_INSTANT_POWER_CURRENT = 0.0;
float L3_INSTANT_POWER_CURRENT = 0.0;
float L1_VOLTAGE = 0.0;
float L2_VOLTAGE = 0.0;
float L3_VOLTAGE = 0.0;
float FREQUENCY = 0.0;
long ACTUAL_TARIF = 0;
